...
-- Run this AFTER applying supabase/schema.sql and RLS migration

-- ============================================================================
-- 1. CATEGORIES (Complete list)
-- ============================================================================
...
-- ============================================================================
-- 6. SAFE MEETUP SPOTS (Ogbomoso verified locations)
-- ============================================================================
...
-- ============================================================================
-- 7. DEFAULT RECENT DEALS (for live ticker)
-- ============================================================================
...
-- ============================================================================
-- 9. DEFAULT RECENT DEALS FOR TICKER
-- ============================================================================
INSERT INTO public.recent_deals (item_title, price, location, time) VALUES
  ('Samsung Galaxy S24 Ultra', 890000, 'Under G, Ogbomoso', '2 minutes ago'),
  ('Toyota Corolla 2015', 1850000, 'Takie Square, Ogbomoso', '8 minutes ago'),
  ('HP Pavilion Laptop', 320000, 'LAUTECH Gate', '15 minutes ago'),
  ('Standing Fan Dual', 25000, 'Sabo Market, Ogbomoso', '22 minutes ago'),
  ('Jollof Rice 50kg', 18500, 'Oja Oba Market', '30 minutes ago')
ON CONFLICT DO NOTHING;

-- ============================================================================
-- 10. AUDIT LOG ENTRY
-- ============================================================================
INSERT INTO public.audit_logs (action, details, type, user_id)
SELECT 'Production Seed Completed', 'Initial production seed data applied successfully', 'security', id
FROM public.profiles WHERE email = 'admin@sealify.ng'
ON CONFLICT DO NOTHING;
