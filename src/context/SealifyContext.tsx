...
const INITIAL_MOCK_USERS: UserProfile[] = [
  ...
  {
    id: 'usr_3',
    email: 'kemi.properties@sealify.ng',
    ...
    verified: true,
    verificationType: 'premium',
    businessName: 'Kemi Real Estate Ltd',
...
const INITIAL_FALLBACK_LISTINGS: Listing[] = [
  ...
  },
  {
    ...
    sellerVerified: true,
    sellerVerificationType: 'business',
    title: 'Apple MacBook Air 15" M2 (8GB RAM, 512GB SSD)',
    description: 'Space Gray M2 MacBook Air with Retina Display, Battery cycle count 42, includes original Apple MagSafe 3 charger and box.',
    price: 1280000,
    category: 'Electronics',
    condition: 'Like New',
    location: 'Sabo Market, Ogbomoso',
    status: 'active',
    images: [
  ...
  },
  {
    ...
    sellerVerified: true,
    sellerVerificationType: 'individual',
    title: 'Lexus RX 350 2015 AWD (Full Option Leather)',
    description: 'Tokunbo standard Lexus RX350 with pristine cream leather, thumbstart keyless entry, navigation screen, and sound V6 engine.',
    price: 16200000,
    category: 'Vehicles',
    condition: 'Used - Good',
    location: 'Oja Igbo, Ogbomoso',
    status: 'active',
    images: [
  ...
  },
  {
    ...
    sellerVerified: true,
    sellerVerificationType: 'premium',
    title: 'Executive Royal L-Shaped Sectional Sofa Set',
    description: 'High density foam 7-seater fabric sofa set with matching throw pillows and wooden centerpiece table.',
    price: 380000,
    category: 'Home & Furniture',
    condition: 'Brand New',
    location: 'General Area, Ogbomoso',
    status: 'active',
    images: [
  ...
  },
  {
    ...
    sellerVerified: true,
    sellerVerificationType: 'individual',
    title: 'Handcrafted Nigerian Designer Agbada & Senator Attire',
    description: 'Premium tailored royal blue Agbada set with intricate hand embroidery. Comes with matching cap and pants (Size L/XL).',
    price: 65000,
    category: 'Fashion',
    condition: 'Brand New',
  ...
  },
  {
    ...
    sellerVerified: true,
    sellerVerificationType: 'business',
    title: '5KVA Hybrid Solar Inverter + 4x 220Ah Gel Batteries',
    description: 'Complete 24/7 solar backup system for homes and offices. Includes installation, pure sine wave inverter, solar panels, and surge protection.',
    price: 1850000,
    category: 'Services',
    condition: 'Brand New',
    location: 'LAUTECH Gate, Ogbomoso',
    status: 'active',
    images: [
  ...
  },
  {
    ...
    sellerVerified: true,
    sellerVerificationType: 'premium',
    title: 'Full Stack Web Developer & Mobile App Engineer Position',
    description: 'Hiring experienced React & Node.js software developer for remote & hybrid tech hub role in Ogbomoso. Competitive NGN salary package.',
    price: 350000,
    category: 'Jobs',
    condition: 'Brand New',
    location: 'LAUTECH Area, Ogbomoso',
  ...
  },
  {
    ...
    sellerVerified: true,
    sellerVerificationType: 'business',
    title: 'Professional Multi-Function Gym Fitness & Workout Bench',
    description: 'Adjustable weight bench with leg developer and dumbbell rack set for home fitness and professional workout sessions.',
    price: 185000,
