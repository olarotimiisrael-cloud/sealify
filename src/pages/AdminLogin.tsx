      ...
      <main className="max-w-md mx-auto w-full px-4 flex-1 flex flex-col justify-center py-12">
        <div className="bg-slate-900 border-2 border-slate-800 rounded-[2.5rem] p-8 shadow-2xl space-y-6 relative overflow-hidden">
          ...
          <div className="text-center space-y-3">
            <div className="w-16 h-16 bg-slate-950 border border-emerald-500/20 rounded-2xl flex items-center justify-center mx-auto shadow-inner">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-11 pr-4 py-3 text-xs text-emerald-400 focus:outline-none focus:border-emerald-500 font-mono disabled:opacity-50" 
                />
              </div>
            </div>
          ...
          <div className="pt-4 border-t border-slate-800 flex items-center justify-center gap-2 opacity-40">
