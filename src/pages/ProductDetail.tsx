...
export default function ProductDetail() {
  ...
  const { listings, isSaved, toggleSaveListing, isAuthenticated, sendMessage, addRecentlyViewed } = useSealify();
            ...
            <div className="bg-slate-900/60 border border-slate-800/80 rounded-3xl p-5 space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 text-amber-400 font-bold text-xs uppercase tracking-wider">
                  <ShieldAlert className="w<dyad-write path="src/pages/ProductDetail.tsx">
