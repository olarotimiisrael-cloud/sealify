      ...
      <header className="sticky top-0 z-40 bg-slate-900 text-white border-b border-slate-800 shadow-xl font-sans">
        <div className="max-w-7xl mx-auto px-4 py-2.5 flex items-center justify-between gap-4">
          ...
          <div className="hidden lg:flex items-center gap-2">
            <Link to="/wanted" className="flex items-center gap-1.5 px-3 py-2 text-xs font-bold text-emerald-400 hover:text-emerald-300 transition-colors mr-1">
              ...
              <div className="relative">
                ...
                {showUserDropdown && (
                  <div className="absolute top-full mt-2 right-0 w-56 bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl p-2 z-50 animate-in fade-in zoom-in-95 duration-100 text-xs">
                    ...
                    {isAdmin && (
                      <Link to="/admin" onClick={() => setShowUserDropdown(false)} className="flex items-center gap-2 px-3 py-2.5 bg-rose-500/10 hover:bg-rose-500/20 rounded-xl text-rose-400 font-black transition-colors my-1 border border-rose-500/20">
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden bg-slate-900 border-b border-slate-800 p-4 space-y-4">
            <div className="grid grid-cols-2 gap-2">
              <Link to="/wanted" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center justify-center gap-2 p-3 bg-slate-950 border border-slate-800 rounded-2xl text-xs font-bold text-emerald-400">
                <TrendingUp className="w-4 h-4" /> Wanted
              </Link>
