...
export const INITIAL_NOTIFICATIONS: AppNotification[] = [
  {
    ...
    description: 'The price on "2021 Tesla Model 3 Long Range" dropped from $31,000 to $28,500 (-8% off)!',
    time: '15 mins ago',
    read: false,
  ...
  },
  {
    ...
    description: 'David Chen replied: "Is $1,550 okay if I pick it up today?" for MacBook Pro 16".',
    time: '1 hour ago',
    read: false,
    linkUrl: '/messages',
  },
  {
    ...
    description: '1 new listing matching your search alert "Sony Alpha A7 IV" was posted in Jersey City.',
    time: '3 hours ago',
    read: true,
